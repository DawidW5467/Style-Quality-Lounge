...
--
-- Host: 127.0.0.1
-- Generation Time: Cze 08, 2025 at 02:00 PM
...
INSERT INTO `carts` (`id_cart_position`, `id_user`, `id_product`) VALUES
(1, 1, 2),
(2, 1, 3),
(3, 2, 1),
(4, 3, 4),
...
--
ALTER TABLE `carts`
  MODIFY `id_cart_position` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
